      ...
      {filteredFlights.length === 0 ? (
        ...
        filteredFlights.map(flight => (
          <div key={flight.id} className="border p-4 rounded mb-4 shadow">
            ...
            <p><strong>السعر:</strong> {flight.price} ج.م</p>
            <p><strong>شركة الطيران:</strong> {flight.airline}</p>
            <p><strong>تاريخ المغادرة:</strong> {new Date(flight.departure).toLocaleString()}</p>
            <p><strong>تاريخ الوصول:</strong> {new Date(flight.arrival).toLocaleString()}</p>
              <button
